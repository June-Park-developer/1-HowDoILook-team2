...
export const STYLES = [
  {
    ...
    imageUrls: [
      `${process.env.RENDER_EXTERNAL_URL}/download/card_frame00-resources.assets-1272-1741841755986.png`,
      `${process.env.RENDER_EXTERNAL_URL}/download/card_frame01-resources.assets-1244-1741841813146.png`,
    ],
    viewCount: 120,
  ...
  },
  {
    ...
    imageUrls: [
      `${process.env.RENDER_EXTERNAL_URL}/download/card_frame02-resources.assets-1224-1741841832624.png`,
      `${process.env.RENDER_EXTERNAL_URL}/download/card_frame03-resources.assets-1213-1741841845911.png`,
    ],
    viewCount: 250,
  ...
  },
  {
    ...
    imageUrls: [
      `${process.env.RENDER_EXTERNAL_URL}/download/card_frame07-resources.assets-1120-1741841860919.png`,
      `${process.env.RENDER_EXTERNAL_URL}/download/card_frame08-resources.assets-1034-1741841873130.png`,
    ],
    viewCount: 340,
