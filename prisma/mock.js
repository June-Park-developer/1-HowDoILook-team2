export const STYLES = [
  {
    ...
    imageUrls: [`${process.env.RENDER_EXTERNAL_URL}/download/1.jpg`],
    viewCount: 120,
  ...
  },
  {
    ...
    imageUrls: [`${process.env.RENDER_EXTERNAL_URL}/download/2.jpg`],
    viewCount: 250,
  ...
  },
  {
    ...
    imageUrls: [`${process.env.RENDER_EXTERNAL_URL}/download/3.jpg`],
    viewCount: 340,
